...
class Workload : Callable {
 public:
  ...
  bool tail_watchdog_armed;
  Tick tail_last_log_tick;
  Tick tail_watchdog_interval;
  uint64_t tail_last_streams_finished;
  Tick tail_wait_start_tick;
  Tick tail_last_progress_tick;
  Tick tail_stall_report_interval;
  Tick tail_last_stall_report_tick;
  Tick tail_last_next_event_tick;
  std::string tail_last_sample_signature;
  uint64_t tail_watchdog_counter;
  Tick tail_last_recovery_tick;
  Tick tail_soft_recovery_interval;
  Tick tail_hard_recovery_interval;
  bool tail_hard_recovery_fired;
  uint64_t tail_recovery_attempts;
  bool sim_end_notified;
};
} // namespace AstraSim
#endif
